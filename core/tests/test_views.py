...
#Testing logic in View
    ...
    def test_add_coupon_view(
        ...
        self.assertIn('You can not use one coupon two times', send_post_add_coupon_request())
        ...
        #Assert that Response which we get from page are correct
        self.assertIn('This coupon was successfully added to your order', send_post_add_coupon_request())
